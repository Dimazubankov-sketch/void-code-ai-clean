...
// Доп. задержка перед выдачей готового ответа. Раньше на max стояло 400мс,
// но пользователь просил мгновенных откликов — реальный «эффект размышления»
// и без этого создаёт ThinkingIndicator, пока идёт настоящий запрос к
// провайдеру. Дополнительная искусственная пауза только раздражает.
// Оставляем нули на всех уровнях: сразу как модель ответила — печатаем.

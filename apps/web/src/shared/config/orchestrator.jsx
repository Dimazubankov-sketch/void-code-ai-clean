...
// На Free оркестраторы недоступны. На Plus можно купить РОВНО ОДНОГО
// оркестратора (жёсткий лимит покупки: максимум 1, больше купить нельзя).
// Pro — до 3, Ultra — до 5. При откате на бесплатный тариф уже купленные
// оркестраторы блокируются до оплаты подписки Plus и выше.
...
// Доступны ли оркестраторы на тарифе (покупка и работа)
export const canUseOrchestrators = (plan) => getOrchestratorLimit(plan) > 0;

// ------------------------------------------
// Лимиты обычных агентов по тарифам
// ------------------------------------------

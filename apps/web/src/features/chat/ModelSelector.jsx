    ...
    return (
        <div className="relative min-w-0">
            <PressButton
                ...
                className={compact
                    ? "void-tap-target flex items-center h-9 px-3.5 rounded-full bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors text-left min-w-0"

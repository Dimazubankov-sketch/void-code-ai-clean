...
export function PricingView({ state, updateState }) {
    ...
    const PRICING_PLANS = [
        { id: 'free', title: 'Free', subtitle: 'Бесплатный доступ. Идеально для знакомства с Void Code AI и базовых задач.', priceMonth: 0, priceYear: 0, features: ["Умный чат с AI", "Обучающие материалы", "Генератор кода — до 10 запросов", "Стандартная скорость", "Базовые модели AI", "Конструктор сайтов: 1 сайт/день", "Агенты: 1 агент", "Оркестраторы недоступны"] },
        { id: 'plus', title: 'Plus', subtitle: 'Больше мощностей и меньше ограничений для работы с кодом.', priceMonth: 350, oldPriceMonth: 500, priceYear: 3500, features: ["Безлимитный чат", "Генератор кода — до 200 запросов", "Приоритетная скорость", "Доступ к мощным моделям", "Конструктор сайтов: 3 сайта/день", "Агенты: до 5 агентов", "Оркестраторы недоступны"] },
        { id: 'pro', title: 'Pro', subtitle: 'Максимум возможностей для разработчиков, фрилансеров и команд.', priceMonth: 1200, oldPriceMonth: 1500, priceYear: 12000, features: ["Безлимитно всё", "Максимальная скорость ответов", "Приоритетная поддержка", "Доступ к самым мощным моделям", "Уровень рассуждений Max", "Конструктор сайтов: 5 сложных сайтов/день", "Агенты: до 10 агентов", "Оркестраторы: до 3"] },
        { id: 'pro_plus', title: 'Ultra', subtitle: 'Максимальные мощности и конструктор сайтов на полную — для компаний и масштабных проектов.', priceMonth: 8000, oldPriceMonth: 10000, priceYear: 100000, features: ["Всё из тарифа Pro", "Админ-панель и доступы", "Личный менеджер", "API интеграция", "Уровень рассуждений Max", "Конструктор сайтов: 8–10 сложных сайтов/день", "Агенты: до 20 агентов", "Оркестраторы: до 5"] }
    ];

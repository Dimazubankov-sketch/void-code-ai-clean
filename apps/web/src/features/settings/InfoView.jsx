...
const FAQ_ITEMS = [
    ...
    },
    {
        ...
        a: 'На бесплатном тарифе разговор ведёт быстрая модель — её хватает для повседневных вопросов. На Pro и Ultra голосовой режим работает на премиальных моделях более высокого качества: ответы точнее, лучше держится контекст длинного разговора и тоньше понимаются формулировки. На Ultra вдобавок подключается модель с углублёнными рассуждениями — она включается автоматически на сложных темах, когда нужно что-то объяснить, сравнить или обосновать. Объём озвучки в сутки тоже зависит от тарифа и растёт вместе с ним.',
    },
    {

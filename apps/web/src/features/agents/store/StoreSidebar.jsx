...
// Боковая навигация вкладки «Агенты»: слева на ПК, снизу на телефоне.
// Три кнопки, как в старом магазине, но «Мои агенты» и «Магазин агентов»
// поменялись местами (иконки и логика): «Мои агенты» теперь первая и
// открывает Cockpit (лендинг вкладки), «Магазин агентов» — вторая.
const NAV = [
    { id: 'my', label: 'Мои агенты', icon: 'Robot' },
    { id: 'store', label: 'Магазин агентов', icon: 'Store' },
        ...
        <>
            ...
            <aside className="hidden sm:flex w-56 flex-shrink-0 flex-col border-r border-gray-100 dark:border-darkBorder bg-white dark:bg-darkCard p-3 gap-1">
                <div className="flex items-center gap-2.5 px-3 py-4 mb-2">
                    ...
                    <span className="font-extrabold text-lg dark:text-white">Агенты</span>
                </div>
                {NAV.map(n => {

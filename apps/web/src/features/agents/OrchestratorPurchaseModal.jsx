...
export function OrchestratorPurchaseModal({ state, updateState, onClose, stayInPlace = false }) {
    ...
    const buy = () => {
        ...
        updateState({
            ...
            activeAgentId: id,
            // В конструкторе агентов остаёмся на месте; из Cockpit — открываем чат
            ...(stayInPlace ? {} : { currentView: 'orchestrator-chat' }),
        });
        onClose();
    };

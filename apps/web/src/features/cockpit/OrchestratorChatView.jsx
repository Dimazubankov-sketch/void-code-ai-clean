...
export function OrchestratorChatView({ state, updateState }) {
    ...
    const close = () => updateState({ currentView: 'cockpit', activeAgentId: null });
    ...
    return (
        <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/50 backdrop-blur-sm fade-in p-0 sm:p-4" onClick={close}>
                ...
                <div className="bg-white dark:bg-darkCard border-b border-gray-100 dark:border-darkBorder shrink-0">
                    ...
                    <div className="flex items-center gap-3 px-4 pt-4 pb-3">
                        <div className="relative w-11 h-11 rounded-2xl bg-[#efecf9] dark:bg-purple-900/20 flex items-center justify-center shrink-0">
                            <Icons.RobotArmy className="w-6 h-6 text-[#5b32d4] dark:text-purple-400" />
                ...
                <div className="flex-1 overflow-y-auto px-4 py-5 space-y-3">
                    {thread.length === 0 && (
                        <div className="text-center text-gray-400 py-12">
                            <Icons.RobotArmy className="w-12 h-12 mx-auto mb-3 text-gray-300" />

            ...
            <div className={`fixed top-0 right-0 h-full w-[85vw] md:w-96 bg-white dark:bg-darkCard shadow-2xl z-50 transform transition-transform duration-300 flex flex-col ${state.isRightMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
                <div className="p-6 flex-1 flex flex-col relative overflow-hidden">
                    ...
                    <div className="space-y-3 mb-6">
                        ...
                        <button onClick={() => updateState({currentView: 'cockpit', isRightMenuOpen: false})} className="w-full flex items-center gap-3 p-4 rounded-2xl bg-gray-50 dark:bg-gray-800/50 hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-800 dark:text-gray-200 font-bold transition-colors border border-gray-100 dark:border-darkBorder">
                            <Icons.RobotArmy /> Cockpit
                        </button>
